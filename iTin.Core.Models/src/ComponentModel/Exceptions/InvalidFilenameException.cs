...
public class InvalidFileNameException : Exception
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="InvalidFileNameException"/> class with a specified error message and a reference to the inner exception that is the cause of this exception.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="InvalidFileNameException"/> class with serialized data.
    /// </summary>
