...
public class BaseModel<T>
{
    ...
    protected virtual string GetStaticBindingValue(string value)
    {
        ...
        var isBinded = Helpers.RegularExpressionHelper.IsStaticBindingResource(value);
        if (!isBinded)
        {
            return value;
        }
        ...
        foreach (var reference in references)
        {
            ...
            var qualifiedAssemblyPathParsed = iTinPath.PathResolver(qualifiedAssemblyPath); //, root);
