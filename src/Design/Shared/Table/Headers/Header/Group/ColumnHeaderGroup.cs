...
public partial class ColumnHeaderGroup
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ColumnHeaderGroup"/> class.
    /// </summary>
    ...
    [XmlIgnore]
    [Browsable(false)]
    public IColumnHeader Parent { get; private set; }
    ...
    internal void SetParent(IColumnHeader parent)
    {
        Parent = parent;
    }
